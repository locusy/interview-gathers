...
面试题汇总：
  ...
  4、一个在data(){}中的变量a，改变其数据后渲染到视图的步骤是什么？
  ...
  7、computed和watch都能监听数据的变化，那他们的区别是什么？（商汤科技）
      官网上有
      computed 有缓存机制 触发才会改变值 https://cn.vuejs.org/v2/api/#computed
  ...
  20、虚拟dom和真实dom的区别？为什么用虚拟dom？（商汤科技）
      https://github.com/livoras/blog/issues/13
      https://juejin.im/post/5c8e5e4951882545c109ae9c#heading-5
      虚拟dom是只更新改变的部分
      真实dom更新的是全部

  21、Object.defineProperty() 和 Proxy 的区别
