...
1、排除打包文件的办法
    ...
    3、webpack 和其他自动化构建工具（gulp、grunt、rollup）有哪些区别
    ...
    4、webpack 的 loader 和 plugin 区别，举几个常用的 loader 和 plugin 并说出作用
      loader：
    ...
    6、webpack 打包之后生成哪些文件
    7、webpack 打包出来的文件体积过大怎么办

    8、怎么将js文件打包成多个js文件
    8、webpack 热部署的原理
    9、webpack 打包速度过慢怎么办？

    10、less-loader实现原理（商汤科技）
        less是怎么编译成css文件的
        

    11、压缩js代码是怎么实现优化性能的？（商汤科技）
        减少空格和注释
        主要是将变量和函数名称用简单的字符代替  比如a b c d等

    12、tree-shakeing是如何干掉无用重复的代码的？
